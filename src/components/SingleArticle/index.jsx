          ...
          <div className="row h-full">
            <div className="col-12 col-lg-8 offset-lg-2 align-self-center">
              ...
              <p>
                ...
                <a className="text-white" href="#foo">Alex De Souza</a>
              </p>
              <p>
            ...
            <div className="row">
              <div className="col-12 col-lg-8 offset-lg-2">
                <p className="lead">
                  ...
                  next-generation content. Seamlessly extend sustainable networks via plug-and-play
                  niche markets. Progressively communicate customized alignments for client-focused
                  services. Holisticly cultivate professional mindshare with impactful niche
                  markets. Dynamically fabricate market-driven collaboration and idea-sharing
                  with turnkey.
                </p>
                <hr className="w-100" />
                <p>
                  ...
                  world-class channels. Objectively disseminate multimedia based methodologies
                  whereas robust.
                </p>
                <p>
                  Compellingly plagiarize economically sound opportunities and cross-platform
                  e-business. Completely embrace alternative initiatives whereas innovative
                  services. Holisticly e-enable one-to-one internal or &ldquo;organic&rdquo;
                  sources via interactive technologies. Energistically leverage other&apos;s
                  end-to-end e-tailers with goal-oriented innovation. Objectively evolve
